...
# Querying Data in SQLite with Python
...
# ### Selecting New Album to Purchase
# 
...
# The record label specializes in artists from the USA
# 
# TASK: find out which genres sell the most tracks?
# 
...
# 
# Because there are a number of countries with only one customer,
# I'll Group these customers as 'Other'
